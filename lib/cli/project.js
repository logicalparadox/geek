...
program
  ...
  .option('-s, --short', 'Specify project shortname to be used for vars, files.')
...
function makeProject (args) {
  ...
  if (!opts.project.shortname) {
    opts.project.shortname = opts.project.name;
  }
